...
//       const config = {
//         headers: {
//           "x-auth-token": token, // Correctly using token from localStorage
//         },
//       };
...
//                     Priority: <span className={getPriorityColor(task.priority).split(" ")[1]}>{task.priority}</span>
//                   </span>
//                 </div>
//                 <div className="flex items-center gap-2">
//                   <Users className="h-4 w-4 text-muted-foreground" />
//                   <span className="text-sm">Department: {task.department?.name || "None"}</span>
//                 </div>
//               </div>
//             </CardContent>
//           </Card>
...
//                   <p className="font-medium text-green-500">Task Completed</p>
//                 </div>
//               </CardContent>
//             </Card>
//           )}
